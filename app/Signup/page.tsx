        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            <div className="flex gap-4 mb-6">
              ...
              >
                {selectedRole === "trainee" && (
                  <Check className="absolute top-2 right-2 text-[#00ff66]" />
                )}
              ...
              >
                ...
                <div className="flex justify-center mb-2">
                  <Badge className="w-6 h-6 text-[#00ff66]" />
                </div>
                <p className="text-white font-semibold text-center mb-1">
                  Join as Trainer
                </p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-4 w-full py-3 rounded-3xl bg-gradient-to-b from-[#00ff66]/80 to-[#00ff66] text-black font-semibold hover:from-[#00ff66] hover:to-[#00ff66]/90 transition disabled:opacity-50"
              >
